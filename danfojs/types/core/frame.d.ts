 ...
 * @returns DataFrame
 */
export declare class DataFrame extends Ndframe {
    col_data: any;
    columns: any;
     ...
     *
     */
    to_csv(csvFilePath?: string): Promise<string>;
    /**
     ...
     *
     */
    drop(kwargs?: {}): DataFrame | undefined;
    /**
     ...
     * @return {DataFrame}
     */
    __cum_ops(axis: number | undefined, ops: any): DataFrame;
    /**
     ...
     * @returns {DataFrame}
     */
    query(kwargs: any): DataFrame | undefined;
    /**
     ...
     * @return {DataFrame}
     */
    fillna(kwargs?: {}): DataFrame | undefined;
    /**
     ...
     */
    dropna(kwargs?: {}): DataFrame | undefined;
    /**
     ...
     * @returns {DataFrame}
     */
    rename(kwargs?: {}): DataFrame | undefined;
    /**
     * Sort DataFrame by index
     * @param {*} kwargs {inplace: Boolean, ascending: Bool}
     * @returns DataFrame
     */
    sort_index(kwargs?: {}): DataFrame | undefined;
    /**
     * Sort a Dataframe in ascending or descending order by a specified column name.
     *  @param {kwargs} Object, {by: Column name to sort by
     *                           ascending (Bool): Whether to return sorted values in ascending order or not,
     ...
     * @returns {Series}
     */
    sort_values(kwargs?: {}): DataFrame | undefined;
