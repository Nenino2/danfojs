export declare class Utils {
    ...
    /**
       ...
       */
    __sample_from_iter(array: any[], k: number, destructive: any): any[];
    __range(start: any, end: any): number[];
     ...
     */
    __count_nan(arr: any, return_val: boolean | undefined, isSeries: any): number | any[];
    __median(arr: any, isSeries: any): any;
    __mode(arr: any): number[];
    __round(arr: any, dp: number | undefined, isSeries: any): any[];
     ...
     */
    _sort_arr_with_index(arr1: any, arr2: any, dtype: any): any;
}
